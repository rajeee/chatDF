// SettingsModal — standalone modal for all app settings.
// Extracted from the inline Settings panel for a cleaner left sidebar.
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-surface rounded-lg p-6 max-w-md w-full mx-4 shadow-xl max-h-[80vh] overflow-y-auto"
      ...
      >
        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            {showAbout ? (
              <div data-testid="about-modal" className="p-3 border border-border rounded bg-black/5 dark:bg-white/5 animate-fade-in">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-sm font-semibold">ChatDF</h3>
                  <button
