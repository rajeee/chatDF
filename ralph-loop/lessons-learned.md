...
- **Auto-detect joinable columns**: Match column names case-insensitively and check type compatibility (numeric-to-numeric, string-to-string) to suggest JOIN queries across datasets.
