...
| U3 | Save panel widths + sidebar state to localStorage | 3 | 1 | 3.0 | pending |
...
| ID | Idea | Impact | Effort | Priority | Status |
|----|------|--------|--------|----------|--------|
| C1 | Global React error boundary with graceful fallback UI | 4 | 1 | 4.0 | pending |
...
| C7 | Copy SQL query button in message bubbles | 3 | 1 | 3.0 | pending |
