...
| M2 | Mobile-responsive left panel close on conversation select | 3 | 1 | 3.0 | done |
| M3 | Touch-friendly delete/action buttons (always visible, not hover-only) | 4 | 2 | 2.0 | done |
| M4 | Responsive chat input layout for narrow screens | 3 | 2 | 1.5 | done |
