...
- **Many ChatHistory/API tests are pre-existing failures**: MSW handler interception issues cause ~20 tests to fail. Not caused by code changes — check before investigating.
