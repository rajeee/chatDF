...
- [ ] Simplify welcome/onboarding screen: Remove the numbered 1-2-3 step list. The welcome screen should just be: "chatDF" title, a [Try with preset sources] button, and a line saying "...or load your own data". Rename "Try with sample data" to "Try with preset sources" everywhere.
