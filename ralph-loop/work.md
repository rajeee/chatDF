...
- [x] Remove the "Copy SQL" button from chat message bubbles (MessageBubble). The copy button inside the SQL modal is sufficient — having it in the chat is redundant clutter. *(Done: iteration 60 — removed button, prop, handler, and tests. Commit 4007735)*
