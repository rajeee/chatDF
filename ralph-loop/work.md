...
- [ ] **Remove BookmarkPanel + bookmarkStore entirely.** Delete: `BookmarkPanel.tsx`, `stores/bookmarkStore.ts`, all bookmark tests. Remove bookmark imports/refs from `LeftPanel.tsx`. The SavedQueries feature already does this.
